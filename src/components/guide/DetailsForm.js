...
class DetailsForm extends React.Component{
  render(){
    return(
      ...
      <br />
      <div className="mx-auto col-12 rounded" style={{
        ...
        <br />
					<form autoComplete="off" >
						...
						<div className="form-group">
							<label htmlFor="thrust1">Thrust area associated with area of interest 1</label>
							<select type="thrust1"
								name="thrust1"
								id="thrust1"
								className="form-control border-0" >
						...
						<div className="form-group">
							<label htmlFor="thrust2">Thrust area associated with area of interest 2</label>
							<select type="thrust2"
								name="thrust2"
								id="thrust2"
								className="form-control border-0" >
						...
						<div className="form-group">
							<label htmlFor="thrust3">Thrust area associated with area of interest 3</label>
							<select type="thrust3"
								name="thrust3"
								id="thrust3"
								className="form-control border-0" >
						...
						<div className="form-group">
							<label htmlFor="thrust4">Thrust area associated with area of interest 4</label>
							<select type="thrust4"
								name="thrust4"
								id="thrust4"
								className="form-control border-0" >
              ...
              <button
								className="btn btn-outline-success" style={{marginBottom:"1em"}}>						
									Submit
							</button>             
					</form>
