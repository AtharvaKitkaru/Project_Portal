      ...
      <div className="project-details mx-auto" style={{ width: "90%" }}>
        ...
        <div className="d-flex flex-md-row flex-column my-3 py-3">
          ...
          <div className="col-md-6 right-panel  ">
            ...
            <ul className="list-group">
              <p className="text-muted">
                Members (Shown only if proj type is inter disciplinary)
              ...
              <Link to="/users/student/:id">
                <li className="list-group-item d-flex list-group-item-action my-2">
                  ...
                  <div className="col-5 m-0 px-1">
                    <span>Student Name: Jil Shah </span>                    
                  </div>
                  <div className="col-1 m-0 px-1" />
                   <div className="col-3 m-0 px-1">                    
                    <span>Branch: IT </span> 
              ...
              <Link to="/users/student/:id">
                <li className="list-group-item d-flex list-group-item-action my-2">
                  ...
                  <div className="col-5 m-0 px-1">
                    <span>Student Name: Jill S. </span>                    
                  </div>
                  <div className="col-1 m-0 px-1" />
                   <div className="col-3 m-0 px-1">                    
                    <span>Branch: EXTC</span> 
                  </div>
                </li>
              </Link>
            </ul>
